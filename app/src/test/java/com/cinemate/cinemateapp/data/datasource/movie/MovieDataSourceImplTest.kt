...
class MovieDataSourceImplTest {
    ...
    fun getNowPlaying() = runTest {
        val page = 1
        val expectedNowPlayingResponse = NowPlayingResponse(
            dates = DatesNowPlayingResponse(
                maximum = "2024-05-17",
                minimum = "2024-05-01"
            ),
            page = 1,
    ...
    fun getPopular() = runTest {
        val page = 1
        val expectedPopularMovieResponse = PopularMovieResponse(
            page = 1,
            results = listOf(
    ...
    @Test
    fun getTopRating() = runTest {
        val page = 1
        val expectedTopRatedResponse = TopRatedResponse(
            page = 1,
            results = listOf(
    ...
    fun getUpcoming() = runTest {
        val page = 1
        val expectedUpcomingMovieResponse = UpcomingMovieResponse(
            dates = DatesUpcomingResultResponse(
                maximum = "2024-05-17",
                minimum = "2024-05-01"
            ),
            page = 1,
